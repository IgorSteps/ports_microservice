...
func (x *Port) Reset() {
	*x = Port{}
	if protoimpl.UnsafeEnabled {
		mi := &file_external_proto_ports_proto_msgTypes[0]
...
func (*Port) Descriptor() ([]byte, []int) {
	return file_external_proto_ports_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreatePortRequest) Reset() {
	*x = CreatePortRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_external_proto_ports_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreatePortRequest) Descriptor() ([]byte, []int) {
	return file_external_proto_ports_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreatePortResponse) Reset() {
	*x = CreatePortResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_external_proto_ports_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreatePortResponse) Descriptor() ([]byte, []int) {
	return file_external_proto_ports_proto_rawDescGZIP(), []int{2}
}
...
var File_external_proto_ports_proto protoreflect.FileDescriptor

var file_external_proto_ports_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x02, 0x0a,
	...
	0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x9b, 0x02,
	...
	0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x9c, 0x02, 0x0a, 0x12,
	...
	0x6e, 0x74, 0x72, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x05, 0x20,
	...
	0x74, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x02, 0x52, 0x0b, 0x63, 0x6f, 0x6f, 0x72, 0x64,
	...
	,
}

var (
	file_external_proto_ports_proto_rawDescOnce sync.Once
	file_external_proto_ports_proto_rawDescData = file_external_proto_ports_proto_rawDesc
)

func file_external_proto_ports_proto_rawDescGZIP() []byte {
	file_external_proto_ports_proto_rawDescOnce.Do(func() {
		file_external_proto_ports_proto_rawDescData = protoimpl.X.CompressGZIP(file_external_proto_ports_proto_rawDescData)
	})
	return file_external_proto_ports_proto_rawDescData
}

var file_external_proto_ports_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_external_proto_ports_proto_goTypes = []interface{}{
	(*Port)(nil),               // 0: Port
	(*CreatePortRequest)(nil),  // 1: CreatePortRequest
	(*CreatePortResponse)(nil), // 2: CreatePortResponse
}
var file_external_proto_ports_proto_depIdxs = []int32{
	1, // 0: PortService.CreatePort:input_type -> CreatePortRequest
	2, // 1: PortService.CreatePort:output_type -> CreatePortResponse
...
func init() { file_external_proto_ports_proto_init() }
func file_external_proto_ports_proto_init() {
	if File_external_proto_ports_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_external_proto_ports_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Port); i {
			case 0:
				return &v.state
			case 1:
		...
		file_external_proto_ports_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_external_proto_ports_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_external_proto_ports_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_external_proto_ports_proto_goTypes,
		DependencyIndexes: file_external_proto_ports_proto_depIdxs,
		MessageInfos:      file_external_proto_ports_proto_msgTypes,
	}.Build()
	File_external_proto_ports_proto = out.File
	file_external_proto_ports_proto_rawDesc = nil
	file_external_proto_ports_proto_goTypes = nil
	file_external_proto_ports_proto_depIdxs = nil
}
