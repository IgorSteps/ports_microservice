...
type GetPortListResponse struct {
	...
	Books []*Port `protobuf:"bytes,1,rep,name=books,proto3" json:"books,omitempty"`
}
...
func (x *GetPortListResponse) GetBooks() []*Port {
	if x != nil {
		return x.Books
	}
	return nil
...
var file_ports_proto_rawDesc = []byte{
	...
	0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x52,
	0x05, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x32, 0x48, 0x0a, 0x0a, 0x50, 0x6f, 0x72, 0x74, 0x44, 0x6f,
...
var file_ports_proto_depIdxs = []int32{
	0, // 0: GetPortListResponse.books:type_name -> Port
